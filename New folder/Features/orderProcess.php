...
<body>
	...
	<div class="receivedContainer">
		<div class="notedContainer">ORDER NOTED, BAP!</div>
		<div class="prepareContainer">
			YOUR FOOD IS NOW
			<br>
			IN PREPARATION
		</div>
		<div class="estimateContainer">Estimated Wait Time: 30 minutes</div>
		<div class="deliveredContainer">
			<a href="../Features/ThankYouWebPage.php">
                <button class="receiveButton"><span class="receiveText">IKWA KU NE BAP</span></button>
            </a>
		</div>
	</div>
    <div class="spaceContainerConfirmation"></div>
